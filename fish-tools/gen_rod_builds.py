...
HYBRIDS = [
    ...
    ("왕실 어사 낚싯대",   "숙련형", "행운형", "A", "왕도", "왕도", True),
    ("근위 어부 낚싯대",   "숙련형", "크리형", "A", "왕도", "왕도", True),
    ("왕도 상회 낚싯대",   "상인형", "성장형", "A", "왕도", "왕도", True),
    ("왕립 서고 낚싯대",   "크리형", "성장형", "A", "왕도", "왕도", True),
    ("왕실 연회 낚싯대",   "상인형", "숙련형", "A", "왕도", "왕도", True),
...
def main():
    ...
    if stale:
        raise SystemExit(f"카탈로그에 없는 기존 낚싯대(이름 유지 원칙 위반): {stale}")
    for c in cat:
