...
두 제약이 «강화만으로는 안 되고, 부품이 나머지를 대야 한다»를 강제한다. 그래서 3층:
    ...
    ① 낚싯대 기본  숙련 D2/C3/B4/A5/S6 · 혼합 D2/C3/B3/A3/S4 · 기타 D1/C1/B2/A3/S3 · 채집 0
    ② 강화 총량    숙련 D1/C2/B3/A4/S5 · 혼합 D1/C1/B2/A2/S3 · 기타 D0/C2/B2/A2/S4 · 채집 0
...
ROD_PLAN = {
    ...
    "튼튼한 막대기":       ("난이도:2,도망감소:2,경험치:2", None),
    "참나무 낚싯대":       ("난이도:3,도망감소:11,경험치:5", None),
    "전문가 낚싯대":       ("난이도:4,도망감소:11,경험치:6", None),
    "낚시견습생의 낚싯대":  ("난이도:1,크리확률:7,크기:11", None),
    "낚시꾼의 낚싯대":     ("난이도:1,크리확률:11,크기:15", None),
    "예리한 낚싯대":       ("난이도:2,크리배율:1,크리확률:11,크기:15", None),
    "대나무 막대기":       ("난이도:1,등급업:3,행운:11", None),
    "잉어꾼의 낚싯대":     ("난이도:1,등급업:4,행운:14,등급특화:C:50", None),
    "숙련자의 낚싯대":     ("난이도:2,등급업:5,행운:14", None),
    "장터 낚싯대":         ("난이도:1,판매보너스:8,더블찬스:3", None),
    "장사꾼의 낚싯대":     ("난이도:1,판매보너스:13,더블찬스:4", None),
    "거래상의 낚싯대":     ("난이도:2,판매보너스:19,더블찬스:8", None),
    "수련생 낚싯대":       ("난이도:1,경험치:9,트리플찬스:1", None),
    "경험의 낚싯대":       ("난이도:1,경험치:13,트리플찬스:2", None),
    "학도의 낚싯대":       ("난이도:2,경험치:19,트리플찬스:2", None),
    "다목적 낚싯대":       ("난이도:3,도망감소:6,판매보너스:10,더블찬스:4", None),
    "겸업 낚싯대":         ("난이도:2,등급업:4,크리확률:6,크기:11", None),
    "만능 낚싯대":         ("난이도:3,도망감소:6,판매보너스:10,더블찬스:5", None),
    "채집용 낚싯대":       ("경험치:3,재료확률:11", None),
    "수집가의 낚싯대":     ("경험치:4,재료확률:16", None),
