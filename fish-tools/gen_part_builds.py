...
────────────────────────────────────────────────────────────────────────────
  ...
  ★★★**2026-09-10 D/C 난이도 부품 정책**: D급 부품의 난이도는 전면 제거한다. C급은
    조작에 직접 관여하는 `철제 릴`·`나일론줄`·`가벼운 찌` 3종만 `난이도:1` **단일 옵션**으로
    둔다. 나머지 C급(단련된·날카로운·단련된 미끼 등)은 각 원래 라인의 스탯만 남긴다.
    B/A 숙련형 시리즈는 이번 저티어 조정 범위 밖이다.
...
PRESERVE_PARTS = {
    ...
    ("릴", "단련된 릴"): "단련된 릴|C|41200|130|도망감소:26,경험치:15,행운:3|16|스폰마을",
    ...
    ("릴", "억센 릴"): "억센 릴|D|26900|70|도망감소:26,경험치:7,행운:2|9|스폰마을",
    ...
    ("미끼", "단련된 미끼"): "단련된 미끼|C|13312|130|행운:7,도망감소:24|17|스폰마을",
    ...
    ("미끼", "억센 미끼"): "억센 미끼|D|5604|70|행운:4,도망감소:24|9|스폰마을",
    ...
    ("찌", "단련된 찌"): "단련된 찌|C|30200|130|등급업:5,행운:3|16|스폰마을",
