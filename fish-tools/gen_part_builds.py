...
TYPE_VAL = {
    ...
    "경험치":   {"E": 0, "D": 15, "C": 35, "B": 55, "A": 75},    # ★2026-08-26 ×2/3 (구 20/50/80/110)
...
TYPE_BASE = {   # 특화형이 아닌 빌드도 그 타입다움은 남긴다(주스탯 하한)
    ...
    "경험치":   {"E": 0, "D": 7,  "C": 15, "B": 30, "A": 40},   # ★2026-08-26 ×2/3 (구 10/25/45/60)
...
SUB_VAL = {
    ...
    "경험치":     {"E": 0, "D": 5, "C": 12, "B": 20, "A": 30},   # ★2026-08-26 ×2/3 (구 8/18/30/45)
