...
2026-09-10 유저 결정: `dogam|대양|36` 을 빼고 «작살로 대양에서 200마리».

★200마리와 A등급 16마리는 **별개 목표**다(유저 확인) — 하나가 다른 하나를 포함하는 구조가
아니다. 그래서 A16 에는 지역을 붙이지 않는다: 대양 200 은 지역 사냥이고, A16 은 어디서
잡아도 되는 등급 목표다. (같은 목표 줄 두 개가 같은 어획을 동시에 세는 것 자체는 정상 —
목표별 카운터가 따로 돌아간다.)
...
QID = "배상단08b"
NEW_GOALS = ["harpoon|아무|아무|200|0|대양", "harpoon|아무|A|16|0"]
OLD_DESC_LINE = "&7&f작살로 대양에서 200마리&7 — 그중 &fA등급 이상 16마리&7."
NEW_DESC_LINE = "&7&f작살로 대양에서 200마리&7 · &f작살로 A등급 이상 16마리&7."
