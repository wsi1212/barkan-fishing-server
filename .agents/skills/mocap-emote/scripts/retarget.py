...
ZFIGHT = {
    "pw_waist": (0, 0, 0.05), "pc_chest": (0, 0, -0.05), "h_ph_head": (0, 0, 0.05),
    "pra_right_arm": (0, 0, -0.06), "pla_left_arm": (0, 0, -0.06),
    "prfa_right_forearm": (0.06, -0.03, -0.07), "plfa_left_forearm": (-0.06, -0.03, -0.07),
    "prl_right_leg": (0, 0, 0.05), "pll_left_leg": (0, 0, -0.05),
    "prfl_right_foreleg": (0.04, -0.02, 0.05), "plfl_left_foreleg": (-0.04, -0.02, -0.05),
}
