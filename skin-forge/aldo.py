...
SEED = 95
P = dict(skin=ramp('cf9d78'), hair=ramp('4f3a2a'), vest=ramp('b08a34'),
         shirt=ramp('c9bda1'), hat=ramp('6b5433'), teal=ramp('2f7d78'),
         brass=ramp('b08d3c'), boot=ramp('4a3a2b'), iris=ramp('4a3a2c'))
