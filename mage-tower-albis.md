...
> - `WeatherManager`의 오로라 **날씨 타입 자체**(전역·심야 커튼, 경험치+15%·크리확률+20%,
>   `AuroraDisplayManager` 리소스팩 커튼 + `RegionParticleTask` 파티클)는 **마탑과 무관한 독립 기능**이다.
>   퀘스트에서 떼어내는 것과 **날씨를 삭제하는 것은 별개 결정** — 삭제 여부는 유저 확인 대기.
