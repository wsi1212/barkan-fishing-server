(() => {
  ...
  if (!document.getElementById('barkan-site-nav-style')) {
    ...
    style.textContent = `
      ...
      .barkan-site-panel{position:absolute;z-index:5;top:calc(100% + 12px);left:50%;width:min(430px,calc(100vw - 30px));padding:18px;border:1px solid var(--nav-line);background:rgba(7,24,24,.98);box-shadow:0 18px 45px rgba(0,0,0,.34);backdrop-filter:blur(16px);transform:translateX(-50%)}.barkan-site-panel[hidden]{display:none}.barkan-site-panel-head{margin:0 0 13px;color:var(--nav-faint);font:700 9px/1.4 ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,monospace;letter-spacing:.1em;text-transform:uppercase}.barkan-site-panel-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:1px;border-top:1px solid var(--nav-soft-line);border-left:1px solid var(--nav-soft-line)}.barkan-site-panel-grid a{display:flex;min-height:66px;flex-direction:column;justify-content:center;padding:11px 12px;border-right:1px solid var(--nav-soft-line);border-bottom:1px solid var(--nav-soft-line);color:var(--nav-text);text-decoration:none}.barkan-site-panel-grid a:hover,.barkan-site-panel-grid a:focus-visible,.barkan-site-panel-grid a[aria-current="page"]{background:rgba(35,91,78,.34);color:var(--nav-accent)}.barkan-site-panel-grid strong{font-size:13px;font-weight:700}.barkan-site-panel-grid span{margin-top:4px;color:var(--nav-faint);font-size:10px;line-height:1.35}.barkan-site-panel-grid a:hover span,.barkan-site-panel-grid a[aria-current="page"] span{color:var(--nav-muted)}
      ...
      .barkan-site-mobile-menu{position:absolute;z-index:5;top:calc(100% + 12px);right:0;width:min(430px,calc(100vw - 30px));padding:18px;border:1px solid var(--nav-line);background:rgba(7,24,24,.98);box-shadow:0 18px 45px rgba(0,0,0,.34);backdrop-filter:blur(16px)}.barkan-site-mobile-menu[hidden]{display:none}.barkan-site-mobile-group{padding:0 0 15px;margin-bottom:15px;border-bottom:1px solid var(--nav-soft-line)}.barkan-site-mobile-group:last-child{padding-bottom:0;margin-bottom:0;border-bottom:0}.barkan-site-mobile-group h2{margin:0 0 8px;color:var(--nav-accent);font-size:12px}.barkan-site-mobile-group a{display:block;padding:7px 0;color:var(--nav-muted);font-size:13px;text-decoration:none}.barkan-site-mobile-group a:hover,.barkan-site-mobile-group a:focus-visible,.barkan-site-mobile-group a[aria-current="page"]{color:var(--nav-text)}
      ...
      @media(max-width:720px){.barkan-site-nav{height:72px}.barkan-site-links{display:none}.barkan-site-tools{gap:6px}.barkan-site-profile{padding:7px 9px;font-size:11px}.barkan-site-menu-toggle{display:inline-flex;padding:7px 9px}.barkan-site-mobile-menu{right:-1px}}
  ...
  host.innerHTML = `<nav class="barkan-site-nav" aria-label="주 메뉴"><a class="barkan-site-brand" href="/"><strong>BARKAN</strong><small>ISLANDS</small></a><div class="barkan-site-links" role="menubar">${desktopGroups}</div><div class="barkan-site-tools"><a class="barkan-site-profile" data-auth-link href="/community/login">로그인</a><button class="barkan-site-menu-toggle" type="button" aria-expanded="false" aria-controls="barkan-site-mobile-menu"><i aria-hidden="true"><span></span><span></span><span></span></i><b>메뉴</b></button></div><div class="barkan-site-mobile-menu" id="barkan-site-mobile-menu" hidden>${mobileGroups}</div></nav>`;
  ...
  groupsEls.forEach(group => {
    ...
    tab.addEventListener('click', () => {
      ...
      closeGroups();
      closeMobile();
      if (!open) { tab.setAttribute('aria-expanded', 'true'); panel.hidden = false; }
    });
  ...
  const allLinks = [...host.querySelectorAll('.barkan-site-panel-grid a,.barkan-site-mobile-menu a')];
