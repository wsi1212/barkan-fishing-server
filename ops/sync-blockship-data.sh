...
FILES=(npc.json dialogue.json titles.json parts.json enhance.json recipes.json materials.json fragment-economy.json quests.json fish.json item-flavor.json cashshop.json)
