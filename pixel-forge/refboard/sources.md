# 레퍼런스 보드 — 출처 (참조용으로만 사용, 파일 재배포 금지)
- paidpacks/foraging-pack_*.png — MCModels "Mushroom Pack | Gather, Cook & Eat" (상품 페이지 공개 이미지) https://mcmodels.net/products/11414/foraging-pack
