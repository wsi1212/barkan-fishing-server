...
def farm_scarecrow(seed=0):
    ...
    # 넓은 밀짚 챙 + 크라운 + 짙은 띠. 레퍼런스의 단순한 황금색 머리 실루엣을 차용했다.
    k.box((2.0, 26.7, 2.6), (14.0, 28.1, 13.4), hat, rot=("z", -22.5))
    k.rounded_box((5.0, 27.3, 5.0), (11.0, 31.7, 11.0), hat, bevel=1, rot=("z", -22.5))
    k.box((4.9, 27.4, 4.9), (11.1, 29.0, 11.1), patch, rot=("z", -22.5))
    return _build(k)
