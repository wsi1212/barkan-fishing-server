...
def farm_scarecrow(seed=0):
    ...
    # 소매 끝에서 삐져나온 밀짚 손과 몇 가닥 — 팔 길이 실루엣을 분명히 한다.
    k.box((-3.4, 15.1, 6.2), (0.2, 18.6, 9.8), straw)
    k.box((15.8, 15.1, 6.2), (19.4, 18.6, 9.8), straw)
    for f, t, rr in [((-5.0, 15.1, 7.0), (-2.5, 16.0, 7.8), ("z", -22.5)),
                     ((-4.7, 17.6, 8.2), (-2.5, 18.4, 9.0), ("z", 22.5)),
                     ((18.5, 15.0, 7.0), (21.0, 15.9, 7.8), ("z", 22.5)),
                     ((18.5, 17.6, 8.2), (20.7, 18.4, 9.0), ("z", -22.5))]:
        k.box(f, t, straw, rot=rr)
