...
def farm_scarecrow(seed=0):
    ...
    # 가까이서 읽히는 의복 디테일 — 목수건, 단추, 팔꿈치 덧댐, 손목 묶음.
    k.box((5.1, 18.5, 5.2), (10.9, 19.7, 6.0), patch)                        # 목수건 띠
    k.box((7.1, 16.7, 5.0), (9.3, 19.0, 5.7), patch, rot=("z", 22.5))       # 늘어진 매듭
    k.box((9.4, 15.5, 5.25), (10.25, 16.35, 5.72), dark)                    # 단추 1
    k.box((9.0, 12.7, 5.25), (9.85, 13.55, 5.72), dark)                     # 단추 2
    ...
    k.box((5.4, 24.2, 4.12), (7.1, 25.7, 4.62), dark, rot=("z", -22.5))
    k.box((8.9, 24.2, 4.12), (10.6, 25.7, 4.62), dark, rot=("z", 22.5))
