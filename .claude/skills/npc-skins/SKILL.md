...
description: >-
  ...
  claude-in-chrome(실제 크롬, WebFetch/서버curl은 스킨사이트 403) + 오라클 SSH
...
- **claude-in-chrome 연결 필수** — WebFetch/서버 curl은 NameMC 등 스킨 사이트에서 403.
...
## 2. NameMC 태그 브라우징 + 콘택트시트 (claude-in-chrome)
