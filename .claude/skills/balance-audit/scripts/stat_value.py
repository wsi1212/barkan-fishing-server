...
# ★2026-08-05 2차 갱신 — 부품 5종 정체성 재배정(gen_part_builds.py)으로 두 스탯의 실현가능
#   최대치가 바뀌었다. 난이도 12→37(로드12 + 부품5종 전부 A급 숙련형 5×5=25, minigame_sim.py
#   실측 rb=37→G성공률≈71%). 트리플찬스 13→20(로드S급5 + 부품5종 전부 성장형 A급3×5=15).
#   부품엔 강화가 없으므로(강화="낚싯대별" 전용) 이 값들이 진짜 상한이다.
MAX_MAGNITUDE = {
    "판매보너스 (1%)": 110, "더블찬스 (1%)": 110, "트리플찬스 (1%)": 20,
    "등급업 (1%)": 56, "크기 (1%)": 100, "행운 (1점)": 100, "도주감소 (1%)": 50,
    "크리확률 (1%)": 80, "크리배율 (1점)": 15, "경험치 (1%)": 255, "난이도 (1점)": 37,
}
